...
INSERT INTO SP_SENSOR(id, name, sensor_value, sensor_type) VALUES(-4, 'Outside Temperature', 8.0, 'TEMPERATURE');

INSERT INTO SP_BUILDING(id, name, outside_temperature_id) VALUES(-10, 'Mines', -4);
